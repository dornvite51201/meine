...
void Scene::incrementScore()
{
    ...
    if(score > bestScore)
    bestScore = score;
    qDebug() << "Wynik:" << score << "Najlepszy wynik:" << bestScore;
}
...
void Scene::showGameOverGraphics()
{
    ...
    QString htmlString = "<p> Wynik:" + QString::number(score) + "</p>"
                         + "<p> Najlepszy wynik:" + QString::number(bestScore) + "</p>";
